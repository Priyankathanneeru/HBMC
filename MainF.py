...
st.markdown(f'<h1 style="color:#FF0000;font-size:50px;text-align:center">{"Suspicious Activity Recognition"}</h1>', unsafe_allow_html=True)
...
if uploaded_file is None:
    ...
    st.markdown(f'<h1 style="color:#FFFFFF;font-size:12px;">{"Uploaded"}</h1>')
    st.text("Uploaded")
