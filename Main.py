...
st.set_page_config(page_title="Human Behavior Monitoring", page_icon="✅")
...
nav_selection = st.sidebar.radio("Navigation", ["Home", "Upload Photo"])


#tab1, tab2 = st.tabs(["Home", "Upload Photo"])
...
if nav_selection == "Home":
    add_bg_from_local('btsss.JPG') 
    # Set background image and page title
 
    # ... (Your existing code for uploading video and processing)
#with tab2:
elif nav_selection == "Upload Photo":
    # Set background color for the photo upload page
    custom_css_home = """
        <style>
            .stApp {
                background-image: url('data:image/png;base64, YOUR_BASE64_ENCODED_IMAGE');
                background-size: cover;
            }
        </style>
    """
    # st.markdown(custom_css_home, unsafe_allow_html=True)
    st.markdown(f'<h1>{"Human Behaviour Monitoring And Categorization"}</h1>', unsafe_allow_html=True)
    uploaded_file = st.file_uploader("Choose a video...", type=["mp4", "mpeg"])

    st.markdown('<style>body { background-color: #444444; }</style>', unsafe_allow_html=True)
    add_bg_from_local('jp.JPG') 
...
if uploaded_file is None:
    ...
    st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Uploaded file"}</h1>', unsafe_allow_html=True)
    ...
    if pred_res == 1:
        ...
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = ABUSE"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Hands and fists "}</h1>', unsafe_allow_html=True)
        ...
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = ARREST"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Gun "}</h1>', unsafe_allow_html=True)
        ...
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = ABUSE"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Hammer"}</h1>', unsafe_allow_html=True)
        
        
    elif pred_res == 4:
        print('Identified Suspicious = EXPLOSION')
        print("-----------------------------")
        print("Weapon --> Fire ")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = EXPLOSION"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Fire "}</h1>', unsafe_allow_html=True)
        ...
        print("-----------------------------")
        print("Weapon --> knives or other sharp instruments ")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = ROBBERY"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> knives or other sharp instruments "}</h1>', unsafe_allow_html=True)
        
        
    elif pred_res == 6:
        print('Identified Suspicious = SHOPLIFTING')
        print("-----------------------------")
        print("Weapon --> Nothing, done by hand  ")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = SHOPLIFTING"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Nothing, done by hand "}</h1>', unsafe_allow_html=True)

        
    elif pred_res == 7:
        print('Identified Suspicious = STEALING')
        print("--------------------------------------------")
        print("Weapon --> Handheld gun ")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = STEALING"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Handheld gun "}</h1>', unsafe_allow_html=True)
        
    elif pred_res == 8:
        print('Identified Suspicious = VANDALISM')
        print("----------------------------------------------------")
        print("Weapon --> Offhand, random sharp objects")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = VANDALISM"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Offhand, random sharp objects "}</h1>', unsafe_allow_html=True)
        
    elif pred_res == 9:
        print('Identified Suspicious = ROAD ACCIDENTS')
        print("----------------------------------------------------")
        print("Weapon --> Not weapon, occured in Road")   
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Identified Suspicious = ROAD ACCIDENTS"}</h1>', unsafe_allow_html=True)
        st.text("--------------------------------------------")
        st.markdown(f'<h1 style="color:#FFFFFF;font-size:16px;">{"Weapon --> Not weapon, occured in Road "}</h1>', unsafe_allow_html=True)      
